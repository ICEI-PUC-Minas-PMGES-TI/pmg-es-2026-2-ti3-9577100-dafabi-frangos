...
API Spring Boot da primeira versão do sistema. Nesta etapa, disponibiliza o domínio de **Produtos** e suas categorias, persistidos em PostgreSQL e versionados com Flyway.
